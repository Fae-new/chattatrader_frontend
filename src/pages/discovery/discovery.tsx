  ...
  <div className="relative w-full">
    ...
    />
      ...
      <div className="w-full max-w-7xl mx-auto space-y-4">
        ...
        <Tabs value={selectedChain} onValueChange={(val) => handleChainClick(val as Chain)}>
  ...
  >
    <div className="space-y-6">
      <div className="text-center text-lg font-semibold">
        {tradeAction === "buy" ? `Buy ${showTradeModal.name}` : `Sell ${showTradeModal.name}`}
      </div>
        ...
        <div className="flex justify-end">
          <button
            className={`px-6 py-2 text-[#FAFAFA] rounded-md text-sm ${
              tradeAction === "buy" ? "bg-[#FF9500]" : "bg-red-600 hover:bg-red-500"
            }`}
          >
